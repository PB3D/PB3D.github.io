\hypertarget{namespacenum__utilities}{}\doxysection{num\+\_\+utilities Module Reference}
\label{namespacenum__utilities}\index{num\_utilities@{num\_utilities}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1con}{con}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1con2dis}{con2dis}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1conv__mat}{conv\+\_\+mat}}
\begin{DoxyCompactList}\small\item\em Converts a (symmetric) matrix A with the storage convention described in \mbox{\hyperlink{structeq__vars_1_1eq__2__type}{eq\+\_\+vars.\+eq\+\_\+2\+\_\+type}}. \end{DoxyCompactList}\item 
interface \mbox{\hyperlink{interfacenum__utilities_1_1dis2con}{dis2con}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1order__per__fun}{order\+\_\+per\+\_\+fun}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1round__with__tol}{round\+\_\+with\+\_\+tol}}
...
interface \mbox{\hyperlink{interfacenum__utilities_1_1spline}{spline}}
...
\begin{DoxyCompactItemize}
\item 
integer function \mbox{\hyperlink{namespacenum__utilities_ac6699d422f3a588b51234c2d62ff389f}{calc\+\_\+inv\+\_\+0d}} (inv\+\_\+0D, A)
\begin{DoxyCompactList}\small\item\em private constant version \end{DoxyCompactList}\item 
subroutine, public \mbox{\hyperlink{namespacenum__utilities_af461ae4c95a7a45da875dcf311e323f5}{calc\+\_\+aux\+\_\+utilities}} (n\+\_\+mod)
...
integer function \mbox{\hyperlink{namespacenum__utilities_af2e9ffd7ce2f9391bf8b6f1c344fabca}{calc\+\_\+derivs\+\_\+1d\+\_\+id}} (deriv, dims)
...
integer function, dimension(\+:,\+:), allocatable, public \mbox{\hyperlink{namespacenum__utilities_ac827c18dd05a9b5a06675eac942f3b51}{derivs}} (order, dims)
\begin{DoxyCompactList}\small\item\em Returns derivatives of certain order. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacenum__utilities_a00f4cfe18a734eaa5d66f529e52f7c31}{check\+\_\+deriv}} (deriv, max\+\_\+deriv, sr\+\_\+name)
...
integer function, public \mbox{\hyperlink{namespacenum__utilities_a2d5d9c66db19fb6edeeb50db6182397f}{calc\+\_\+ext\+\_\+var}} (ext\+\_\+var, var, var\+\_\+points, ext\+\_\+point, deriv\+\_\+in)
\begin{DoxyCompactList}\small\item\em Extrapolates a function. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacenum__utilities_a4dffe3beba7165dd17cff19a99a9e2ac}{calc\+\_\+coeff\+\_\+fin\+\_\+diff}} (deriv, nr, ind, coeff)
\begin{DoxyCompactList}\small\item\em Calculate the coefficients for finite differences. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacenum__utilities_a5ee3fbd1fe67d0deefc7194631389f2a}{c}} (ij, sym, n, lim\+\_\+n)
...
recursive integer function, public \mbox{\hyperlink{namespacenum__utilities_a43ab60f9e202b55221373286a5bbb954}{fac}} (n)
\begin{DoxyCompactList}\small\item\em Calculate factorial. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacenum__utilities_a4e6994b5c92b3d16c8538b54db0beadd}{is\+\_\+sym}} (n, nn, sym)
\begin{DoxyCompactList}\small\item\em Determines whether a matrix making use of the storage convention in \mbox{\hyperlink{structeq__vars_1_1eq__2__type}{eq\+\_\+vars.\+eq\+\_\+2\+\_\+type}} is symmetric or not. \end{DoxyCompactList}\item 
recursive integer function, public \mbox{\hyperlink{namespacenum__utilities_a33fc1483c840d5d3f9b12acfce21cad1}{lcm}} (u, v)
...
recursive integer function, public \mbox{\hyperlink{namespacenum__utilities_a3d0d04a582b3a528fc7f9975d5d2a807}{gcd}} (u, v)
\begin{DoxyCompactList}\small\item\em Returns least denominator using the G\+CD. \end{DoxyCompactList}\item 
subroutine, public \mbox{\hyperlink{namespacenum__utilities_ac887f1cc7176167b352dedbd22ff2a57}{shift\+\_\+f}} (Al, Bl, Cl, A, B, C)
...
subroutine, public \mbox{\hyperlink{namespacenum__utilities_a54c65e345182e2e7e13ac14a0ba3647a}{solve\+\_\+vand}} (n, a, b, x, transp)
\begin{DoxyCompactList}\small\item\em Solve a Vandermonde system $\overline{\text{A}} \ \vec{X} = \vec{B}$. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacenum__utilities_ab4c91a6478c4dd6f519f8ccbccc4094f}{calc\+\_\+d2\+\_\+smooth}} (fil\+\_\+N, x, y, D2y, style)
...
\begin{DoxyCompactItemize}
\item 
integer, dimension(\+:,\+:,\+:), allocatable, public \mbox{\hyperlink{namespacenum__utilities_a763215553acfcc054b1ec1bc207a1793}{d}}
\begin{DoxyCompactList}\small\item\em 1-\/D array indices of derivatives \end{DoxyCompactList}\item 
integer, dimension(\+:,\+:), allocatable, public \mbox{\hyperlink{namespacenum__utilities_ad7a7ae2abf02a2df9e00b2aca669617c}{m}}
\begin{DoxyCompactList}\small\item\em 1-\/D array indices of metric indices \end{DoxyCompactList}\item 
integer, dimension(\+:,\+:), allocatable, public \mbox{\hyperlink{namespacenum__utilities_a8e3399292fcb3a5fc35ae87f7811bbb5}{f}}
\begin{DoxyCompactList}\small\item\em 1-\/D array indices of Fourier mode combination indices \end{DoxyCompactList}\item 
logical, public \mbox{\hyperlink{namespacenum__utilities_ab7138a230a3c494c7a2b71b2a7fffc0a}{debug\+\_\+con2dis\+\_\+reg}} = .false.
\begin{DoxyCompactList}\small\item\em plot debug information for con2dis\+\_\+reg() \end{DoxyCompactList}\item 
logical, public \mbox{\hyperlink{namespacenum__utilities_ae20985c8049d39f987fa23d728688cbc}{debug\+\_\+calc\+\_\+coeff\+\_\+fin\+\_\+diff}} = .false.
\begin{DoxyCompactList}\small\item\em plot debug information for \mbox{\hyperlink{namespacenum__utilities_a4dffe3beba7165dd17cff19a99a9e2ac}{calc\+\_\+coeff\+\_\+fin\+\_\+diff()}} \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{num\_utilities@{num\_utilities}!c@{c}}
...
\mbox{\texttt{ in}}  & {\em ij} & 2D coords. (i,j) \\
\hline
\mbox{\texttt{ in}}  & {\em sym} & whether symmetric \\
\hline
\mbox{\texttt{ in}}  & {\em n} & max of 2-\/D coords. \\
\hline
\mbox{\texttt{ in}}  & {\em lim\+\_\+n} & min. and max. of 2-\/D coords. \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!calc\_aux\_utilities@{calc\_aux\_utilities}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em n\+\_\+mod} & n\+\_\+mod for Fourier modes \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!calc\_coeff\_fin\_diff@{calc\_coeff\_fin\_diff}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em deriv} & degree of derivative \\
\hline
\mbox{\texttt{ in}}  & {\em nr} & number of points \\
\hline
\mbox{\texttt{ in}}  & {\em ind} & position of derivative \\
\hline
\mbox{\texttt{ in,out}}  & {\em coeff} & output coefficients \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!calc\_d2\_smooth@{calc\_d2\_smooth}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em fil\+\_\+n} & filter length (must be odd) \\
\hline
\mbox{\texttt{ in}}  & {\em x} & input abscissa \\
\hline
\mbox{\texttt{ in}}  & {\em y} & input ordinate \\
\hline
\mbox{\texttt{ in,out}}  & {\em d2y} & second derivative \\
\hline
\end{DoxyParams}


Definition at line 2829 of file num\+\_\+utilities.\+f90.
...
\index{num\_utilities@{num\_utilities}!calc\_derivs\_1d\_id@{calc\_derivs\_1d\_id}}
\index{calc\_derivs\_1d\_id@{calc\_derivs\_1d\_id}!num\_utilities@{num\_utilities}}
\doxysubsubsection{\texorpdfstring{calc\_derivs\_1d\_id()}{calc\_derivs\_1d\_id()}}
...
\hline
\mbox{\texttt{ in}}  & {\em dims} & nr. of dimensions \\
\hline
\end{DoxyParams}


Definition at line 2146 of file num\+\_\+utilities.\+f90.
...
\index{num\_utilities@{num\_utilities}!calc\_ext\_var@{calc\_ext\_var}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in,out}}  & {\em ext\+\_\+var} & output \\
\hline
\mbox{\texttt{ in}}  & {\em var} & abscissa \\
\hline
\mbox{\texttt{ in}}  & {\em var\+\_\+points} & ordinate \\
\hline
\mbox{\texttt{ in}}  & {\em ext\+\_\+point} & point to which extrapolate \\
\hline
\mbox{\texttt{ in}}  & {\em deriv\+\_\+in} & specifies an optional derivative \\
\hline
\end{DoxyParams}


Definition at line 2325 of file num\+\_\+utilities.\+f90.
...
\index{num\_utilities@{num\_utilities}!calc\_inv\_0d@{calc\_inv\_0d}}
\index{calc\_inv\_0d@{calc\_inv\_0d}!num\_utilities@{num\_utilities}}
...
\index{num\_utilities@{num\_utilities}!check\_deriv@{check\_deriv}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em deriv} & derivative to be checked \\
\hline
\mbox{\texttt{ in}}  & {\em max\+\_\+deriv} & maximum derivative allowed \\
\hline
\mbox{\texttt{ in}}  & {\em sr\+\_\+name} & name of subroutine \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!derivs@{derivs}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em order} & order of derivative \\
\hline
\mbox{\texttt{ in}}  & {\em dims} & nr. of dimensions \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!fac@{fac}}
...
Definition at line 2609 of file num\+\_\+utilities.\+f90.
...
\index{num\_utilities@{num\_utilities}!gcd@{gcd}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em u} & input \\
\hline
\mbox{\texttt{ in}}  & {\em v} & input \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
result 
...
\index{num\_utilities@{num\_utilities}!is\_sym@{is\_sym}}
...
Determines whether a matrix making use of the storage convention in \mbox{\hyperlink{structeq__vars_1_1eq__2__type}{eq\+\_\+vars.\+eq\+\_\+2\+\_\+type}} is symmetric or not. 
...
\hline
\mbox{\texttt{ in}}  & {\em nn} & number of elements in matrix \\
\hline
\mbox{\texttt{ in,out}}  & {\em sym} & output \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!lcm@{lcm}}
...
\index{num\_utilities@{num\_utilities}!shift\_f@{shift\_f}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em al} & limits on A mode numbers \\
\hline
\mbox{\texttt{ in}}  & {\em bl} & limits on B mode numbers \\
\hline
\mbox{\texttt{ in}}  & {\em cl} & limits on C mode numbers \\
\hline
\mbox{\texttt{ in}}  & {\em a} & input \\
\hline
\mbox{\texttt{ in}}  & {\em b} & input \\
\hline
\mbox{\texttt{ in,out}}  & {\em c} & result \\
\hline
\end{DoxyParams}


Definition at line 2696 of file num\+\_\+utilities.\+f90.

Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespacenum__utilities_ac887f1cc7176167b352dedbd22ff2a57_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\index{num\_utilities@{num\_utilities}!solve\_vand@{solve\_vand}}
...
\begin{DoxySeeAlso}{See also}
Adapted from two routines {\ttfamily dvand} and {\ttfamily pvand} in \href{https://people.sc.fsu.edu/~jburkardt/f_src/vandermonde/vandermonde.html}{\texttt{ https\+://people.\+sc.\+fsu.\+edu/$\sim$jburkardt/f\+\_\+src/vandermonde/vandermonde.\+html}} based on the Björk-\/\+Pereyra Algorithm \cite{Bjorck1970}. 
\end{DoxySeeAlso}

\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em n} & matrix size \\
\hline
\mbox{\texttt{ in}}  & {\em a} & parameters of Vandermonde matrix \\
\hline
\mbox{\texttt{ in}}  & {\em b} & right-\/hand side \\
\hline
\mbox{\texttt{ in,out}}  & {\em x} & solution \\
\hline
\mbox{\texttt{ in}}  & {\em transp} & transposed Vandermonde matrix \\
\hline
\end{DoxyParams}
...
\index{num\_utilities@{num\_utilities}!d@{d}}
...
\index{num\_utilities@{num\_utilities}!debug\_calc\_coeff\_fin\_diff@{debug\_calc\_coeff\_fin\_diff}}
...
plot debug information for \mbox{\hyperlink{namespacenum__utilities_a4dffe3beba7165dd17cff19a99a9e2ac}{calc\+\_\+coeff\+\_\+fin\+\_\+diff()}} 
...
\index{num\_utilities@{num\_utilities}!debug\_con2dis\_reg@{debug\_con2dis\_reg}}
...
\index{num\_utilities@{num\_utilities}!f@{f}}
...
\index{num\_utilities@{num\_utilities}!m@{m}}
