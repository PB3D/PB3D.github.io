\hypertarget{namespaceoutput__ops}{}\doxysection{output\+\_\+ops Module Reference}
\label{namespaceoutput__ops}\index{output\_ops@{output\_ops}}
...
\item 
interface \mbox{\hyperlink{interfaceoutput__ops_1_1plot__hdf5}{plot\+\_\+hdf5}}
...
interface \mbox{\hyperlink{interfaceoutput__ops_1_1print__ex__2d}{print\+\_\+ex\+\_\+2d}}
\begin{DoxyCompactList}\small\item\em Print 2-\/D output on a file. \end{DoxyCompactList}\item 
interface \mbox{\hyperlink{interfaceoutput__ops_1_1print__ex__3d}{print\+\_\+ex\+\_\+3d}}
\begin{DoxyCompactList}\small\item\em Print 3-\/D output on a file. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Functions/\+Subroutines}
\begin{DoxyCompactItemize}
\item 
subroutine, public \mbox{\hyperlink{namespaceoutput__ops_a50bfbb88cc91805469353c3ff47b3e2e}{draw\+\_\+ex}} (var\+\_\+names, draw\+\_\+name, nplt, draw\+\_\+dim, plot\+\_\+on\+\_\+screen, ex\+\_\+plot\+\_\+style, data\+\_\+name, draw\+\_\+ops, extra\+\_\+ops, is\+\_\+animated, ranges, delay, persistent)
\begin{DoxyCompactList}\small\item\em Use external program to draw a plot. \end{DoxyCompactList}\item 
subroutine, public \mbox{\hyperlink{namespaceoutput__ops_ab0d14194d01ab0534562eab50b37a57a}{plot\+\_\+diff\+\_\+hdf5}} (A, B, file\+\_\+name, tot\+\_\+dim, loc\+\_\+offset, descr, output\+\_\+message)
...
subroutine \mbox{\hyperlink{namespaceoutput__ops_aa9e4855511b6ea16a08b3efb587bec51}{use\+\_\+execute\+\_\+command\+\_\+line}} (command, exitstat, cmdstat, cmdmsg)
...
\index{output\_ops@{output\_ops}!draw\_ex@{draw\_ex}}
...
\begin{DoxyItemize}
\item {\ttfamily draw\+\_\+dim} = 1\+: 2-\/D plot; should be called with the output of \mbox{\hyperlink{interfaceoutput__ops_1_1print__ex__2d}{output\+\_\+ops.\+print\+\_\+ex\+\_\+2d()}}, {\ttfamily nplt} should be correctly set.
...
\item {\ttfamily draw\+\_\+dim} = 3\+: 2-\/D plot in 3-\/D slices; should be called with the output of \mbox{\hyperlink{interfaceoutput__ops_1_1print__ex__2d}{output\+\_\+ops.\+print\+\_\+ex\+\_\+2d()}}, {\ttfamily nplt} should be correctly set. 
\end{DoxyItemize}
\end{DoxyNote}

\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em var\+\_\+names} & name of variables \\
\hline
\mbox{\texttt{ in}}  & {\em draw\+\_\+name} & name of drawing \\
\hline
\mbox{\texttt{ in}}  & {\em nplt} & number of plots \\
\hline
\mbox{\texttt{ in}}  & {\em draw\+\_\+dim} & 1\+: 2-\/D, 2\+: 3-\/D, 3\+: decoupled 3-\/D \\
\hline
\mbox{\texttt{ in}}  & {\em plot\+\_\+on\+\_\+screen} & True if on screen, false if in file \\
\hline
\mbox{\texttt{ in}}  & {\em ex\+\_\+plot\+\_\+style} & alternative external plot style \\
\hline
\mbox{\texttt{ in}}  & {\em data\+\_\+name} & name of data file \\
\hline
\mbox{\texttt{ in}}  & {\em draw\+\_\+ops} & drawing options \\
\hline
\mbox{\texttt{ in}}  & {\em extra\+\_\+ops} & extra options \\
\hline
\mbox{\texttt{ in}}  & {\em is\+\_\+animated} & plot is animated \\
\hline
\mbox{\texttt{ in}}  & {\em ranges} & x and y range of animated plot \\
\hline
\mbox{\texttt{ in}}  & {\em delay} & time delay between animated plot frames \\
\hline
...
\index{output\_ops@{output\_ops}!plot\_diff\_hdf5@{plot\_diff\_hdf5}}
...
This is similar to a basic version of \mbox{\hyperlink{interfaceoutput__ops_1_1plot__hdf5}{output\+\_\+ops.\+plot\+\_\+hdf5()}}.
...
\hline
\mbox{\texttt{ in}}  & {\em file\+\_\+name} & name of plot \\
\hline
...
\hline
\mbox{\texttt{ in}}  & {\em output\+\_\+message} & whether to display a message or not \\
\hline
\end{DoxyParams}
...
\index{output\_ops@{output\_ops}!use\_execute\_command\_line@{use\_execute\_command\_line}}
\index{use\_execute\_command\_line@{use\_execute\_command\_line}!output\_ops@{output\_ops}}
\doxysubsubsection{\texorpdfstring{use\_execute\_command\_line()}{use\_execute\_command\_line()}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em command} & command to execute \\
\hline
\mbox{\texttt{ in,out}}  & {\em exitstat} & exit status \\
\hline
\mbox{\texttt{ in,out}}  & {\em cmdstat} & command status \\
\hline
\mbox{\texttt{ in,out}}  & {\em cmdmsg} & command message \\
\hline
\end{DoxyParams}
