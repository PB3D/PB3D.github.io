...
See \mbox{\hyperlink{namespacefiles__ops_a1e219b1147f109f758d03bef89d540e8}{init\+\_\+files()}}.
\end{DoxySeeAlso}
...
See \mbox{\hyperlink{namespacemessages_aa4a8d01563e92558e8a0875b075ec54c}{writo()}}.
\end{DoxySeeAlso}

\item The data type {\ttfamily real} refers to double precision real, defined by \mbox{\hyperlink{namespacenum__vars_a03802aa2bd86439d7a9370836fabf3f2}{num\+\_\+vars.\+dp}}. For integers, standard precision is used.
\item There are hard-\/coded {\ttfamily min\+\_\+tol} and {\ttfamily max\+\_\+tol} in \mbox{\hyperlink{namespaceinput__ops_a434acca4f59f9dc1d91e04f846133684}{read\+\_\+input\+\_\+opts()}}, which are used to limit the tolerances {\ttfamily tol\+\_\+rich}, {\ttfamily tol\+\_\+zero} and {\ttfamily tol\+\_\+\+S\+L\+E\+PC}. This could be changed if needed.
\item If {\ttfamily eq\+\_\+style = 2} (i.\+e. H\+E\+L\+E\+NA), the total maximum memory available must be enough to perform the first Richardson level in a single equilibrium job (see \mbox{\hyperlink{page_overview}{General code structure}}).
\end{DoxyItemize}\hypertarget{page_inputs_inputs_PB3D}{}\doxysection{P\+B3\+D Inputs}\label{page_inputs_inputs_PB3D}
\hypertarget{page_inputs_inputs_PB3D_file}{}\doxysubsection{Input file}\label{page_inputs_inputs_PB3D_file}
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ input parameter }&\cellcolor{\tableheadbgcolor}\textbf{ explanation }&\cellcolor{\tableheadbgcolor}\textbf{ default value }&\cellcolor{\tableheadbgcolor}\textbf{ data type }&\cellcolor{\tableheadbgcolor}\textbf{ note  }\\\cline{1-5}
\endfirsthead
\hline
\endfoot
\hline
\cellcolor{\tableheadbgcolor}\textbf{ input parameter }&\cellcolor{\tableheadbgcolor}\textbf{ explanation }&\cellcolor{\tableheadbgcolor}\textbf{ default value }&\cellcolor{\tableheadbgcolor}\textbf{ data type }&\cellcolor{\tableheadbgcolor}\textbf{ note  }\\\cline{1-5}
\endhead
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning solution}}   }\\\cline{1-5}
{\ttfamily n\+\_\+r\+\_\+sol} &number of points in solution grid &$ 100$  &{\ttfamily int} &\\\cline{1-5}
{\ttfamily min\+\_\+r\+\_\+sol} &minimum normalized flux of computational domain $\left(0\ldots 1\right)$ &$0.1$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni1}{1}})   \\\cline{1-5}
{\ttfamily max\+\_\+r\+\_\+sol} &maximum normalized flux of computational domain $\left(0\ldots 1\right)$ &$1.0$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni1}{1}})   \\\cline{1-5}
{\ttfamily tol\+\_\+norm} &tolerance for normal range &$0.05$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni2}{2}})   \\\cline{1-5}
...
\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning field line}}   }\\\cline{1-5}
...
\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning perturbation}}   }\\\cline{1-5}
{\ttfamily min\+\_\+n\+\_\+par\+\_\+X} &minimum number of parallel points for integration &$20$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni3}{3}})  \\\cline{1-5}
...
{\ttfamily prim\+\_\+X} &primary mode number in geodesic direction &$20$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni4}{4}})  \\\cline{1-5}
{\ttfamily min\+\_\+sec\+\_\+X} &minimum secondary mode number in parallel direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni4}{4}}, \mbox{\hyperlink{page_inputs_fni5}{5}})  \\\cline{1-5}
{\ttfamily max\+\_\+sec\+\_\+X} &maximum secondary mode number in parallel direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni4}{4}}, \mbox{\hyperlink{page_inputs_fni5}{5}})  \\\cline{1-5}
{\ttfamily n\+\_\+mod\+\_\+X} &number of secondary modes in parallel direction &$20$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni4}{4}}, \mbox{\hyperlink{page_inputs_fni5}{5}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &{\ttfamily .true.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni35}{35}}) 

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning normalization}}   }\\\cline{1-5}
{\ttfamily rho\+\_\+0} &Normalization factor for density $\rho$ $\frac{kg}{m^3}$ &$10^{-7}$ &{\ttfamily real}  &\\\cline{1-5}
{\ttfamily R\+\_\+0} &Normalization factor for length scale $R$ $m$ &&{\ttfamily real}  &(\mbox{\hyperlink{page_inputs_fni6}{6}})  \\\cline{1-5}
{\ttfamily pres\+\_\+0} &Normalization factor for pressure $p$ $Pa$ &&{\ttfamily real}  &(\mbox{\hyperlink{page_inputs_fni6}{6}})  \\\cline{1-5}
{\ttfamily psi\+\_\+0} &Normalization factor for flux $\Psi$ $T m^2$ &&{\ttfamily real}  &(\mbox{\hyperlink{page_inputs_fni6}{6}})  \\\cline{1-5}
{\ttfamily B\+\_\+0} &Normalization factor for magnetic field $\vec{B}$ $T$ &&{\ttfamily real}  &(\mbox{\hyperlink{page_inputs_fni6}{6}})  \\\cline{1-5}
{\ttfamily T\+\_\+0} &Normalization factor for time $s$ &&{\ttfamily real}  &(\mbox{\hyperlink{page_inputs_fni6}{6}}) 

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning input and output}}   }\\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$2$ &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni7}{7}})  \\\cline{1-5}
{\ttfamily plot\+\_\+resonance} &plot the safety factor (poloidal flux) or rotational transform (toroidal flux) and the resonant values &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni13}{13}})  \\\cline{1-5}
{\ttfamily plot\+\_\+magn\+\_\+grid} &plot magnetic field lines in the flux surfaces in 3-\/D geometry as an animation &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni14}{14}})  \\\cline{1-5}
{\ttfamily plot\+\_\+B} &plot magnetic field $\vec{B} = \nabla \alpha \times \nabla \psi $ $\left[T\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni15}{15}})  \\\cline{1-5}
{\ttfamily plot\+\_\+J} &plot current $\vec{J} = \mu_0^{-1} \nabla \times \left(\nabla \alpha \times \nabla \psi\right) $ $\left[\frac{A}{m^2}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni16}{16}})  \\\cline{1-5}
{\ttfamily plot\+\_\+kappa} &plot curvature $\vec{\kappa} = \frac{\vec{B}}{B} \cdot \nabla \frac{\vec{B}}{B}$ $\left[\frac{1}{m}\right]$ and its components $ \kappa_n = \frac{\nabla \psi}{\left|\nabla \psi\right|^2} \cdot \vec{\kappa} $ $\left[\frac{1}{T m^2}\right]$ and $ \kappa_g = \frac{\nabla \psi \times \vec{B}}{B^2} \cdot \vec{\kappa} $ $\left[\phantom{\cdot}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni17}{17}})  \\\cline{1-5}
{\ttfamily plot\+\_\+flux\+\_\+q} &plot flux quantities $q$, $\iota$, $p$ $\left[Pa\right]$, $\Psi_\text{pol}$ $\left[T m^2\right]$ and $\Psi_\text{tor}$ $\left[T m^2\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni18}{18}})  \\\cline{1-5}
{\ttfamily n\+\_\+theta\+\_\+plot} &number of points in plots in $\theta$ direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni19}{19}})  \\\cline{1-5}
{\ttfamily n\+\_\+zeta\+\_\+plot} &number of points in plots in $\zeta$ direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni19}{19}})  \\\cline{1-5}
...
{\ttfamily min\+\_\+zeta\+\_\+plot} &minimum of $\zeta$ range for plots &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni20}{20}})  \\\cline{1-5}
{\ttfamily max\+\_\+zeta\+\_\+plot} &minimum of $\zeta$ range for plots &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni20}{20}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$1$ &{\ttfamily int}  &(\mbox{\hyperlink{page_inputs_fni21}{21}}) 

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning Richardson extrapolation}}   }\\\cline{1-5}
...
{\ttfamily rich\+\_\+restart\+\_\+lvl} &Richardson level at which to restart a previous simulation &$1$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni8}{8}}) 

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning finding zeros}}   }\\\cline{1-5}
{\ttfamily max\+\_\+it\+\_\+zero} &maximum number of iterations in \mbox{\hyperlink{interfacenum__ops_1_1calc__zero__hh}{num\+\_\+ops.\+calc\+\_\+zero\+\_\+hh()}} and \mbox{\hyperlink{namespacenum__ops_adcc4eacf15c931744316a004f4448b90}{calc\+\_\+zero\+\_\+zhang()}} &$100$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni9}{9}})  \\\cline{1-5}
{\ttfamily tol\+\_\+zero} &tolerance for zero finding &$1^{-10}$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni9}{9}})  \\\cline{1-5}
{\ttfamily max\+\_\+nr\+\_\+backtracks\+\_\+\+HH} &maximum number of times the correction can be relaxed by half in a backtrack for the Householder methods &$20$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni9}{9}})  \\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning runtime}}   }\\\cline{1-5}
{\ttfamily use\+\_\+normalization} &use normalization for the internal calculations &{\ttfamily .true.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni6}{6}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$1$ ({\ttfamily X\+\_\+style} 1), $2$ ({\ttfamily X\+\_\+style} 2) &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni5}{5}}, \mbox{\hyperlink{page_inputs_fni36}{36}})   \\\cline{1-5}
{\ttfamily max\+\_\+njq\+\_\+change} &maximum change of resonant mode numbers for {\ttfamily X\+\_\+grid\+\_\+style} $3$ &$0.49$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni36}{36}})  \\\cline{1-5}
...
{\ttfamily E\+V\+\_\+\+BC} &eigenvalue used in boundary condition of style {\ttfamily B\+C\+\_\+style} = 1 &$1$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni10}{10}})  \\\cline{1-5}
...
$2$ &minimization of surface energy through asymmetric finite differences  \\\cline{1-2}
$3$ &minization through extension of grid  \\\cline{1-2}
$4$ &explicit introduction of the surface energy minimization  \\\cline{1-2}
\end{tabularx}}
~\newline
 &$[1,2]$ &{\ttfamily int(2)} &(\mbox{\hyperlink{page_inputs_fni10}{10}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$1$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni11}{11}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$1$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni12}{12}})  \\\cline{1-5}
\end{longtabu}
\hypertarget{page_inputs_inputs_PB3D_cmd}{}\doxysubsection{Command-\/line inputs}\label{page_inputs_inputs_PB3D_cmd}
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ input parameter }&\cellcolor{\tableheadbgcolor}\textbf{ explanation }&\cellcolor{\tableheadbgcolor}\textbf{ argument }&\cellcolor{\tableheadbgcolor}\textbf{ note  }\\\cline{1-4}
\endfirsthead
\hline
\endfoot
\hline
...
Debug version only 
\end{DoxyNote}
&&(\mbox{\hyperlink{page_inputs_fni28}{28}})   \\\cline{1-4}
{\ttfamily no\+\_\+plots} &do not produce any output plots &&\\\cline{1-4}
{\ttfamily no\+\_\+outputs} &do not produce text output &&(\mbox{\hyperlink{page_inputs_fni29}{29}})   \\\cline{1-4}
{\ttfamily do\+\_\+execute\+\_\+command\+\_\+line} &run the external command line shell commands during execution &&(\mbox{\hyperlink{page_inputs_fni30}{30}})   \\\cline{1-4}
{\ttfamily mem\+\_\+info} &produce memory profiles for each process \begin{DoxyNote}{Note}
Debug version only 
\end{DoxyNote}
&&(\mbox{\hyperlink{page_inputs_fni31}{31}})   \\\cline{1-4}
{\ttfamily no\+\_\+guess} &do not use a guess&&\\\cline{1-4}
{\ttfamily jump\+\_\+to\+\_\+sol} &jump straight to the solution for the Richardson level at which the simulationes are (re)started, possibly for different solution grid parameters such as {\ttfamily n\+\_\+r\+\_\+sol} &&(\mbox{\hyperlink{page_inputs_fni33}{33}})   \\\cline{1-4}
{\ttfamily export\+\_\+\+H\+EL} &create a V\+M\+EC input file from H\+E\+L\+E\+NA variables, possibly adding a toroidal ripple &&(\mbox{\hyperlink{page_inputs_fni34}{34}})   \\\cline{1-4}
...
&&\\\cline{1-4}
\end{longtabu}
\hypertarget{page_inputs_inputs_POST}{}\doxysection{P\+O\+S\+T Inputs}\label{page_inputs_inputs_POST}
\hypertarget{page_inputs_inputs_POST_file}{}\doxysubsection{Input file}\label{page_inputs_inputs_POST_file}
...
\endhead
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning solution}}   }\\\cline{1-5}
{\ttfamily min\+\_\+r\+\_\+plot} &minimum normalized flux of output domain $\left(0\ldots 1\right)$ &&{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni24}{24}})   \\\cline{1-5}
{\ttfamily max\+\_\+r\+\_\+plot} &maximum normalized flux of output domain $\left(0\ldots 1\right)$ &&{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni24}{24}})  

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning input and output}}   }\\\cline{1-5}
{\ttfamily n\+\_\+sol\+\_\+plotted} &number of solutions plotted &{\ttfamily n\+\_\+sol\+\_\+requested} &{\ttfamily int} &\\\cline{1-5}
{\ttfamily pert\+\_\+mult\+\_\+factor\+\_\+\+P\+O\+ST} &factor by which the grid can be perturbed, with respect to the maximum perturbation of each solution independently &$0$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni25}{25}})  \\\cline{1-5}
{\ttfamily plot\+\_\+resonance} &plot the safety factor (poloidal flux) or rotational transform (toroidal flux) and the resonant values &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni13}{13}})  \\\cline{1-5}
{\ttfamily plot\+\_\+magn\+\_\+grid} &plot magnetic field lines in the flux surfaces in 3-\/D geometry as an animation &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni14}{14}})  \\\cline{1-5}
{\ttfamily plot\+\_\+B} &plot magnetic field $\vec{B} = \nabla \alpha \times \nabla \psi $ $\left[T\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni15}{15}})  \\\cline{1-5}
{\ttfamily plot\+\_\+J} &plot current $\vec{J} = \mu_0^{-1} \nabla \times \left(\nabla \alpha \times \nabla \psi\right) $ $\left[\frac{A}{m^2}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni16}{16}})  \\\cline{1-5}
{\ttfamily plot\+\_\+kappa} &plot curvature $\vec{\kappa} = \frac{\vec{B}}{B} \cdot \nabla \frac{\vec{B}}{B}$ $\left[\frac{1}{m}\right]$ and its components $ \kappa_n = \frac{\nabla \psi}{\left|\nabla \psi\right|^2} \cdot \vec{\kappa} $ $\left[\frac{1}{T m^2}\right]$ and $ \kappa_g = \frac{\nabla \psi \times \vec{B}}{B^2} \cdot \vec{\kappa} $ $\left[\phantom{\cdot}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni17}{17}})  \\\cline{1-5}
{\ttfamily plot\+\_\+flux\+\_\+q} &plot flux quantities $q$, $\iota$, $p$ $\left[Pa\right]$, $\Psi_\text{pol}$ $\left[T m^2\right]$ and $\Psi_\text{tor}$ $\left[T m^2\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni18}{18}})  \\\cline{1-5}
{\ttfamily plot\+\_\+sol\+\_\+xi} &plot normal mode $\vec{\xi}$ $\left[m\right]$ and its components $ X = \frac{\nabla \psi}{B^2} \cdot \vec{\xi} $ $\left[\frac{m^2}{T}\right]$ and $ U = \frac{\nabla \psi \times \vec{B}}{\left|\nabla \psi\right|^2} \cdot \vec{\xi} $ $\left[\phantom{\cdot}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni26}{26}})  \\\cline{1-5}
{\ttfamily plot\+\_\+sol\+\_\+Q} &plot magnetic field perturbation due to the normal mode $\vec{Q} = \nabla \times \left(\vec{\xi} \times \vec{B}\right) $ $\left[T\right]$ and its components $ Q_n = \frac{\nabla \psi}{B^2} \cdot \vec{Q} $ $\left[m\right]$ and $ Q_g = \frac{\nabla \psi \times \vec{B}}{\left|\nabla \psi\right|^2} \cdot \vec{Q} $ $\left[\frac{T}{m}\right]$ &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni26}{26}})  \\\cline{1-5}
{\ttfamily plot\+\_\+\+E\+\_\+rec} &plot energy reconstruction &{\ttfamily .false.} &{\ttfamily log} &(\mbox{\hyperlink{page_inputs_fni27}{27}})  \\\cline{1-5}
{\ttfamily n\+\_\+theta\+\_\+plot} &number of points in plots in $\theta$ direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni19}{19}})  \\\cline{1-5}
{\ttfamily n\+\_\+zeta\+\_\+plot} &number of points in plots in $\zeta$ direction &&{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni19}{19}})  \\\cline{1-5}
{\ttfamily min\+\_\+theta\+\_\+plot} &minimum of $\theta$ range for plots &$1$&{\ttfamily int} &\\\cline{1-5}
{\ttfamily max\+\_\+theta\+\_\+plot} &minimum of $\theta$ range for plots &$3$&{\ttfamily int} &\\\cline{1-5}
...
\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning Richardson extrapolation}}   }\\\cline{1-5}
{\ttfamily P\+B3\+D\+\_\+rich\+\_\+lvl} &Richardson level at which to perform post-\/processing &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni22}{22}}) 

\\\cline{1-5}
\multicolumn{5}{|c|}{\PBS\centering {\bfseries{concerning finding zeros}}   }\\\cline{1-5}
{\ttfamily max\+\_\+it\+\_\+zero} &maximum number of iterations in \mbox{\hyperlink{interfacenum__ops_1_1calc__zero__hh}{num\+\_\+ops.\+calc\+\_\+zero\+\_\+hh()}} and \mbox{\hyperlink{namespacenum__ops_adcc4eacf15c931744316a004f4448b90}{calc\+\_\+zero\+\_\+zhang()}} &$100$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni9}{9}})  \\\cline{1-5}
{\ttfamily tol\+\_\+zero} &tolerance for zero finding &$1^{-10}$ &{\ttfamily real} &(\mbox{\hyperlink{page_inputs_fni9}{9}})  \\\cline{1-5}
{\ttfamily max\+\_\+nr\+\_\+backtracks\+\_\+\+HH} &maximum number of times the correction can be relaxed by half in a backtrack for the Householder methods &$20$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni9}{9}}) 
...
\end{tabularx}}
~\newline
 &$1$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni23}{23}})  \\\cline{1-5}
...
\end{tabularx}}
~\newline
 &$0$ &{\ttfamily int} &(\mbox{\hyperlink{page_inputs_fni23}{23}})  \\\cline{1-5}
\end{longtabu}
\hypertarget{page_inputs_inputs_POST_cmd}{}\doxysubsection{Command-\/line inputs}\label{page_inputs_inputs_POST_cmd}
...
{\ttfamily compare\+\_\+tor\+\_\+pos} &compare $\vec{B}$, $\vec{J}$ and $\vec{\kappa}$ from {\ttfamily plot\+\_\+B}, {\ttfamily plot\+\_\+J} and {\ttfamily plot\+\_\+kappa} at different toroidal positions, as well as the difference in position &{\ttfamily R\+Z\+\_\+0(2)} &(\mbox{\hyperlink{page_inputs_fni32}{32}})   \\\cline{1-4}
\end{longtabu}
...
Is used in \mbox{\hyperlink{namespacex__ops_a7d9275e2d927d92548416f21b983b604}{check\+\_\+x\+\_\+modes()}} whether there exists a range in which each of the modes resonates.
...
Normalization constants, with exception of {\ttfamily rho\+\_\+0} are set in the routine \mbox{\hyperlink{namespaceeq__ops_a7cd38586e386e1bc684a327ebcc4c1de}{calc\+\_\+normalization\+\_\+const()}}.
\item \label{page_inputs_fni7}%
\Hypertarget{page_inputs_fni7}%
In \mbox{\hyperlink{namespaceslepc__ops_a24d97496000ed55f1d11e4d436e084a6}{store\+\_\+results()}}, it is decided whether the eigenvalue is physical or not, by considering the ratio between real and imaginary part.
...
For the case of \mbox{\hyperlink{interfacenum__ops_1_1calc__zero__hh}{num\+\_\+ops.\+calc\+\_\+zero\+\_\+hh()}}, at every iteration it is checked whether the correction approximation is better than the original one. If it is not, the correction is relaxed by a factor half. This is done {\ttfamily max\+\_\+nr\+\_\+backtracks\+\_\+\+HH} times.
\item \label{page_inputs_fni10}%
\Hypertarget{page_inputs_fni10}%
See \mbox{\hyperlink{namespaceslepc__ops_a05f8a23335ed47ad1996cddf3bcfdc2e}{set\+\_\+bc()}}.
\item \label{page_inputs_fni11}%
\Hypertarget{page_inputs_fni11}%
See \mbox{\hyperlink{namespaceeq__ops_a7cd38586e386e1bc684a327ebcc4c1de}{calc\+\_\+normalization\+\_\+const()}}.
\item \label{page_inputs_fni12}%
\Hypertarget{page_inputs_fni12}%
See \mbox{\hyperlink{namespaceslepc__ops_a79c420987056c225931b51c8d30ece1f}{solve\+\_\+ev\+\_\+system\+\_\+slepc()}}
\item \label{page_inputs_fni13}%
\Hypertarget{page_inputs_fni13}%
See \mbox{\hyperlink{namespacex__ops_abdaf1308e13cede3a153e8c6cf35a637}{resonance\+\_\+plot()}}.
\item \label{page_inputs_fni14}%
\Hypertarget{page_inputs_fni14}%
See \mbox{\hyperlink{namespacegrid__ops_addd76b7b3be0b51e0863ae0cdfef41e6}{magn\+\_\+grid\+\_\+plot()}}.
\item \label{page_inputs_fni15}%
\Hypertarget{page_inputs_fni15}%
See \mbox{\hyperlink{namespaceeq__ops_a73a8c3cea1e8a636b4978bc626e0fab0}{b\+\_\+plot()}}. The output is done in various coordinate system, as explained in \mbox{\hyperlink{namespacegrid__utilities_ad3d9386b9abcb1a7e17369a1b3a3750d}{calc\+\_\+vec\+\_\+comp()}}.
\item \label{page_inputs_fni16}%
\Hypertarget{page_inputs_fni16}%
See \mbox{\hyperlink{namespaceeq__ops_afabdf28e5c26ceb87e6eb8cf3809919d}{j\+\_\+plot()}}. The output is done in various coordinate system, as explained in \mbox{\hyperlink{namespacegrid__utilities_ad3d9386b9abcb1a7e17369a1b3a3750d}{calc\+\_\+vec\+\_\+comp()}}.
\item \label{page_inputs_fni17}%
\Hypertarget{page_inputs_fni17}%
See \mbox{\hyperlink{namespaceeq__ops_ad173efd111cb85c11bc2bc78a7555096}{kappa\+\_\+plot()}}. The output is done in various coordinate system, as explained in \mbox{\hyperlink{namespacegrid__utilities_ad3d9386b9abcb1a7e17369a1b3a3750d}{calc\+\_\+vec\+\_\+comp()}}.
\item \label{page_inputs_fni18}%
\Hypertarget{page_inputs_fni18}%
See \mbox{\hyperlink{namespaceeq__ops_af0effe20188d46a44680c2648e4572e9}{flux\+\_\+q\+\_\+plot()}}.
...
This refers to the external plots, which are complimentary to the H\+D\+F5 plots. See \mbox{\hyperlink{namespaceoutput__ops_a50bfbb88cc91805469353c3ff47b3e2e}{draw\+\_\+ex()}}.
\item \label{page_inputs_fni22}%
\Hypertarget{page_inputs_fni22}%
If output is done that requires a solution, this needs to be between 1 and the maximum level that was obtained in P\+B3D. See \mbox{\hyperlink{namespacerich__ops_a58e1bed1bed5c2d0b91cc7dc5e3099d9}{find\+\_\+max\+\_\+rich\+\_\+lvl()}}. If no solution is found, some of the outputs that do not depend on this still work.\+Optionally, this can be forced by choosing {\ttfamily P\+B3\+D\+\_\+rich\+\_\+lvl} not positive.
...
These quantities are calculated in \mbox{\hyperlink{interfacesol__utilities_1_1calc__xuq}{sol\+\_\+utilities.\+calc\+\_\+xuq()}}. This is done for a time sequene, currently hard-\/coded in \mbox{\hyperlink{namespacesol__ops_a13b3cf2fb6437a3c93256368fa91c267}{plot\+\_\+sol\+\_\+vec()}}, depending on whether the solution is stable or unstable.
\item \label{page_inputs_fni27}%
\Hypertarget{page_inputs_fni27}%
The energy reconstruction is performed in \mbox{\hyperlink{namespacesol__ops_ae094c2a5235324b4aadb53623978d191}{calc\+\_\+e()}} if either one of {\ttfamily plot\+\_\+sol\+\_\+xi}, {\ttfamily plot\+\_\+sol\+\_\+Q} or {\ttfamily plot\+\_\+\+E\+\_\+rec} is true.
\item \label{page_inputs_fni28}%
\Hypertarget{page_inputs_fni28}%
Equivalent use is through {\ttfamily -\/t}. If this is used, {\ttfamily do\+\_\+execute\+\_\+command\+\_\+line} should be set to true as well. See \mbox{\hyperlink{namespacetest_aca21ee464c0b1f4b617177afdde110ec}{generic\+\_\+tests()}}.
\item \label{page_inputs_fni29}%
\Hypertarget{page_inputs_fni29}%
This is used internally as well, to suppress certain output. See \mbox{\hyperlink{namespacedriver__x_ada3d72a0929daaa5e3da585246d62281}{run\+\_\+driver\+\_\+x()}} and \mbox{\hyperlink{namespacedriver__post_a33b3c6f9018a0ddc92dce77394b8ab37}{run\+\_\+driver\+\_\+post()}}.
\item \label{page_inputs_fni30}%
\Hypertarget{page_inputs_fni30}%
This can fail on local systems, and generally works badly on computational clusters, where the computational nodes often don\textquotesingle{}t have the external tools (see {\ttfamily ex\+\_\+plot\+\_\+style}) installed. By default, an output file is created for the shell commands, which can be executed afterwards. See \mbox{\hyperlink{page_outputs_output_file_shell}{Shell commands file}}.
\item \label{page_inputs_fni31}%
\Hypertarget{page_inputs_fni31}%
This is done by calling \mbox{\hyperlink{namespacemessages_a82dddaab795b78b3d39e1ff1aab2f665}{get\+\_\+mem\+\_\+usage()}} and storing the result at every allocation and deallocation of an {\ttfamily eq\+\_\+1\+\_\+type}, {\ttfamily eq\+\_\+2\+\_\+type}, {\ttfamily X\+\_\+1\+\_\+type}, {\ttfamily X\+\_\+2\+\_\+type}, {\ttfamily vac\+\_\+type} or {\ttfamily sol\+\_\+type}, as well as for input quantities. Furthermore at every user output with \mbox{\hyperlink{namespacemessages_aa4a8d01563e92558e8a0875b075ec54c}{writo()}}, this is also done, and the output is prepended to the output string. Also, the output is written to a file. See \mbox{\hyperlink{page_outputs_output_file_mem}{Memory usage file}}.
\item \label{page_inputs_fni32}%
\Hypertarget{page_inputs_fni32}%
This is useful to calculate the ripple in these quantities. To use this, it is necessary to have an output grid of only 3 points, where the poloidal projection of the middle point should be the in the middle between the poloidal projections of the two others. Also, you have to provide through {\ttfamily R\+Z\+\_\+0} the $R$ and $Z$ value of the origin of the geometrical poloidal angle that is used to calculate distances. See \mbox{\hyperlink{interfacegrid__utilities_1_1calc__tor__diff}{grid\+\_\+utilities.\+calc\+\_\+tor\+\_\+diff()}}.
...
This is a rather complicated procedure with many possibilities that is intended for expert use. See \mbox{\hyperlink{namespaceeq__ops_a9addef683b3d4a8c587510e4c994ec61}{create\+\_\+vmec\+\_\+input()}}.
