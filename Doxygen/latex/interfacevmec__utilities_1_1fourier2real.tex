\hypertarget{interfacevmec__utilities_1_1fourier2real}{}\doxysection{vmec\+\_\+utilities\+::fourier2real Interface Reference}
\label{interfacevmec__utilities_1_1fourier2real}\index{vmec\_utilities::fourier2real@{vmec\_utilities::fourier2real}}
...
\item 
integer function \mbox{\hyperlink{interfacevmec__utilities_1_1fourier2real_a5e88c64e893bd56ad8e19f6c66c7f62a}{fourier2real\+\_\+1}} (varf\+\_\+c, varf\+\_\+s, trigon\+\_\+factors, varr, sym, deriv)
\begin{DoxyCompactList}\small\item\em version with trigonometric factors \end{DoxyCompactList}\item 
integer function \mbox{\hyperlink{interfacevmec__utilities_1_1fourier2real_a6fc4707ce8d461b9fdee24e63c9556ed}{fourier2real\+\_\+2}} (varf\+\_\+c, varf\+\_\+s, theta, zeta, varr, sym, deriv)
...
\index{vmec\_utilities::fourier2real@{vmec\_utilities::fourier2real}!fourier2real\_1@{fourier2real\_1}}
...
\mbox{\texttt{ in}}  & {\em varf\+\_\+c} & $\cos$ factor of variable in Fourier space \\
\hline
\mbox{\texttt{ in}}  & {\em varf\+\_\+s} & $\sin$ factor of variable in Fourier space \\
\hline
\mbox{\texttt{ in}}  & {\em trigon\+\_\+factors} & trigonometric factor cosine and sine at these angles (see \mbox{\hyperlink{namespacevmec__utilities_ac699116fc25fdea3e28e488513d97c87}{calc\+\_\+trigon\+\_\+factors()}}) \\
\hline
\mbox{\texttt{ in,out}}  & {\em varr} & variable in real space \\
\hline
\mbox{\texttt{ in}}  & {\em sym} & whether to use {\ttfamily varf\+\_\+c} (1) and / or {\ttfamily varf\+\_\+s} (2) \\
\hline
\mbox{\texttt{ in}}  & {\em deriv} & optional derivatives in angular coordinates \\
\hline
\end{DoxyParams}
...
\index{vmec\_utilities::fourier2real@{vmec\_utilities::fourier2real}!fourier2real\_2@{fourier2real\_2}}
...
\mbox{\texttt{ in}}  & {\em varf\+\_\+s} & $\sin$ factor of variable in Fourier space \\
\hline
\mbox{\texttt{ in}}  & {\em theta} & $\theta_\text{E}$ \\
\hline
\mbox{\texttt{ in}}  & {\em zeta} & $\zeta_\text{E}$ \\
\hline
\mbox{\texttt{ in,out}}  & {\em varr} & variable in real space \\
\hline
\mbox{\texttt{ in}}  & {\em sym} & whether to use {\ttfamily varf\+\_\+c} (1) and / or {\ttfamily varf\+\_\+s} (2) \\
