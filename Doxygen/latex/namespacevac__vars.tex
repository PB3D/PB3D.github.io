\hypertarget{namespacevac__vars}{}\doxysection{vac\+\_\+vars Module Reference}
\label{namespacevac__vars}\index{vac\_vars@{vac\_vars}}
...
\item 
type \mbox{\hyperlink{structvac__vars_1_1vac__type}{vac\+\_\+type}}
\begin{DoxyCompactList}\small\item\em vacuum type \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Functions/\+Subroutines}
\begin{DoxyCompactItemize}
\item 
integer function \mbox{\hyperlink{namespacevac__vars_a81df0b01b0c2bf8072453f4ca12e2d5e}{init\+\_\+vac}} (vac, style, n\+\_\+bnd, prim\+\_\+X, n\+\_\+ang, jq)
\begin{DoxyCompactList}\small\item\em Initializes a vacuum type. \end{DoxyCompactList}\item 
subroutine, public \mbox{\hyperlink{namespacevac__vars_a5bfa31e3a61464281d70a4e1a8246510}{set\+\_\+loc\+\_\+lims}} (n\+\_\+loc, bs, ind\+\_\+p, n\+\_\+p, lims)
\begin{DoxyCompactList}\small\item\em Calculates the limits in local index. \end{DoxyCompactList}\item 
subroutine \mbox{\hyperlink{namespacevac__vars_aa6669ed787cf96e8f8fa665149bc83a3}{dealloc\+\_\+vac}} (vac)
\begin{DoxyCompactList}\small\item\em Deallocates vacuum variables. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacevac__vars_a8da702035bfcc208bd810258f9944f6a}{copy\+\_\+vac}} (vac, vac\+\_\+copy)
\begin{DoxyCompactList}\small\item\em Copy a vacuum type. \end{DoxyCompactList}\item 
logical function, public \mbox{\hyperlink{namespacevac__vars_af0fd2f819434bf7adc494753df4af19c}{in\+\_\+context}} (ctxt)
...
\begin{DoxyCompactItemize}
\item 
integer, public \mbox{\hyperlink{namespacevac__vars_a48e085d21d3006e777a7052577e89a21}{n\+\_\+alloc\+\_\+vacs}}
...
\index{vac\_vars@{vac\_vars}!copy\_vac@{copy\_vac}}
\index{copy\_vac@{copy\_vac}!vac\_vars@{vac\_vars}}
\doxysubsubsection{\texorpdfstring{copy\_vac()}{copy\_vac()}}
{\footnotesize\ttfamily integer function, public vac\+\_\+vars\+::copy\+\_\+vac (\begin{DoxyParamCaption}\item[{class(\mbox{\hyperlink{structvac__vars_1_1vac__type}{vac\+\_\+type}}), intent(in)}]{vac,  }\item[{class(\mbox{\hyperlink{structvac__vars_1_1vac__type}{vac\+\_\+type}}), intent(inout)}]{vac\+\_\+copy }\end{DoxyParamCaption})}
...
\mbox{\texttt{ in}}  & {\em vac} & vac to be copied \\
\hline
\mbox{\texttt{ in,out}}  & {\em vac\+\_\+copy} & copy \\
\hline
\end{DoxyParams}
...
\index{vac\_vars@{vac\_vars}!dealloc\_vac@{dealloc\_vac}}
\index{dealloc\_vac@{dealloc\_vac}!vac\_vars@{vac\_vars}}
\doxysubsubsection{\texorpdfstring{dealloc\_vac()}{dealloc\_vac()}}
{\footnotesize\ttfamily subroutine vac\+\_\+vars\+::dealloc\+\_\+vac (\begin{DoxyParamCaption}\item[{class(\mbox{\hyperlink{structvac__vars_1_1vac__type}{vac\+\_\+type}}), intent(inout)}]{vac }\end{DoxyParamCaption})}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in,out}}  & {\em vac} & vacuum variables to be deallocated \\
\hline
\end{DoxyParams}
...
\index{vac\_vars@{vac\_vars}!in\_context@{in\_context}}
...
\hline
\mbox{\texttt{ in}}  & {\em style} & style of vacuum (1\+: field-\/line 3-\/D, 2\+: axisymmetric) \\
\hline
\mbox{\texttt{ in}}  & {\em n\+\_\+bnd} & total number of points in boundary \\
\hline
\mbox{\texttt{ in}}  & {\em prim\+\_\+x} & primary mode number \\
\hline
\mbox{\texttt{ in}}  & {\em n\+\_\+ang} & number of angles (1) and number of field lines (2) \\
\hline
\mbox{\texttt{ in}}  & {\em jq} & iota (tor. flux) or q (pol. flux) at edge \\
\hline
\end{DoxyParams}
...
\index{vac\_vars@{vac\_vars}!set\_loc\_lims@{set\_loc\_lims}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em n\+\_\+loc} & number of points owned by local process \\
\hline
\mbox{\texttt{ in}}  & {\em bs} & block size \\
\hline
\mbox{\texttt{ in}}  & {\em ind\+\_\+p} & index of current process in this dimension \\
\hline
\mbox{\texttt{ in}}  & {\em n\+\_\+p} & number of processes in this dimension \\
\hline
\mbox{\texttt{ in,out}}  & {\em lims} & limits for different subregions in this dimension \\
\hline
\end{DoxyParams}
...
\index{vac\_vars@{vac\_vars}!n\_alloc\_vacs@{n\_alloc\_vacs}}
