...
\multirow{10}{\linewidth}{grids of grid\+\_\+vars.\+grid\+\_\+type }&\multicolumn{2}{p{(\linewidth-\tabcolsep*3-\arrayrulewidth*2)*2/3}|}{\PBS\centering {\bfseries equilibrium}   }\\\cline{2-3}
...
\multirow{1}{\linewidth}{flux equilibria of eq\+\_\+vars.\+eq\+\_\+1\+\_\+type }&\multicolumn{2}{p{(\linewidth-\tabcolsep*3-\arrayrulewidth*2)*2/3}|}{only at first Richardson level   }\\\cline{1-3}
\multirow{3}{\linewidth}{metric equilibria of eq\+\_\+vars.\+eq\+\_\+2\+\_\+type }&\multicolumn{2}{p{(\linewidth-\tabcolsep*3-\arrayrulewidth*2)*2/3}|}{only at first Richardson level   }\\\cline{2-3}
&&also output H\+E\+L\+E\+NA grid at first Richardson level  \\\cline{2-3}
&&used later for interpolation to field-\/aligned grid  \\\cline{1-3}
\multirow{1}{\linewidth}{vacuums of vac\+\_\+vars.\+vac\+\_\+type }&at every Richardson level  &only at first Richardson level   \\\cline{1-3}
\multirow{1}{\linewidth}{solutions of sol\+\_\+vars.\+sol\+\_\+type }&\multicolumn{2}{p{(\linewidth-\tabcolsep*3-\arrayrulewidth*2)*2/3}|}{at every Richardson level   }\\\cline{1-3}
\end{longtabu}
