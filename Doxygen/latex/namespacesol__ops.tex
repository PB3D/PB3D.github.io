\hypertarget{namespacesol__ops}{}\doxysection{sol\+\_\+ops Module Reference}
\label{namespacesol__ops}\index{sol\_ops@{sol\_ops}}
...
\item 
subroutine, public \mbox{\hyperlink{namespacesol__ops_a0d4a798a56cfee9bced781d116852165}{plot\+\_\+sol\+\_\+vals}} (sol, last\+\_\+unstable\+\_\+id)
\begin{DoxyCompactList}\small\item\em Plots Eigenvalues. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacesol__ops_a13b3cf2fb6437a3c93256368fa91c267}{plot\+\_\+sol\+\_\+vec}} (mds\+\_\+X, mds\+\_\+sol, grid\+\_\+eq, grid\+\_\+X, grid\+\_\+sol, eq\+\_\+1, eq\+\_\+2, X, sol, X\+YZ, X\+\_\+id, plot\+\_\+var)
\begin{DoxyCompactList}\small\item\em Plots Eigenvectors. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacesol__ops_a5cec8571480fbc319e7987732fd5995c}{plot\+\_\+harmonics}} (mds, grid\+\_\+sol, sol, X\+\_\+id, res\+\_\+surf)
\begin{DoxyCompactList}\small\item\em Plots the harmonics and their maximum in 2-\/D. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacesol__ops_aee487ffbe5d0edff5e37a6500748941c}{decompose\+\_\+energy}} (mds\+\_\+X, mds\+\_\+sol, grid\+\_\+eq, grid\+\_\+X, grid\+\_\+sol, eq\+\_\+1, eq\+\_\+2, X, sol, vac, X\+\_\+id, B\+\_\+aligned, X\+YZ, E\+\_\+pot\+\_\+int, E\+\_\+kin\+\_\+int)
...
integer function \mbox{\hyperlink{namespacesol__ops_ae094c2a5235324b4aadb53623978d191}{calc\+\_\+e}} (mds\+\_\+X, mds\+\_\+sol, grid\+\_\+eq, grid\+\_\+X, grid\+\_\+sol, eq\+\_\+1, eq\+\_\+2, X, sol, vac, B\+\_\+aligned, X\+\_\+id, E\+\_\+pot, E\+\_\+kin, E\+\_\+pot\+\_\+int, E\+\_\+kin\+\_\+int)
\begin{DoxyCompactList}\small\item\em Calculate the energy terms in the energy decomposition. \end{DoxyCompactList}\item 
integer function, public \mbox{\hyperlink{namespacesol__ops_a06eb95d55da45ff2a1f830a380e0cf80}{print\+\_\+output\+\_\+sol}} (grid, sol, data\+\_\+name, rich\+\_\+lvl, remove\+\_\+previous\+\_\+arrs)
...
\begin{DoxyCompactItemize}
\item 
logical, public \mbox{\hyperlink{namespacesol__ops_ae0df0d66ef4ea0155cfbeb23973c28ac}{debug\+\_\+plot\+\_\+sol\+\_\+vec}} = .false.
...
logical, public \mbox{\hyperlink{namespacesol__ops_a4dc364bc6b70b805abdc3ed0ab2e5226}{debug\+\_\+calc\+\_\+e}} = .false.
\begin{DoxyCompactList}\small\item\em plot debug information for calc\+\_\+\+E() \end{DoxyCompactList}\item 
logical, public \mbox{\hyperlink{namespacesol__ops_a718171b8636e5e4ad98fd4e35ca5b71f}{debug\+\_\+x\+\_\+norm}} = .false.
\begin{DoxyCompactList}\small\item\em plot debug information {\ttfamily X\+\_\+norm} \end{DoxyCompactList}\item 
logical, public \mbox{\hyperlink{namespacesol__ops_acb6465b87495933920896a52b4298a4c}{debug\+\_\+du}} = .false.
...
\begin{DoxyNote}{Note}
see explanation of routine in \mbox{\hyperlink{namespacesol__ops_aee487ffbe5d0edff5e37a6500748941c}{decompose\+\_\+energy()}}.
\end{DoxyNote}
...
\hline
\mbox{\texttt{ in}}  & {\em grid\+\_\+sol} & and solution grid \\
\hline
...
\hline
\mbox{\texttt{ in}}  & {\em b\+\_\+aligned} & whether grid is field-\/aligned \\
\hline
\mbox{\texttt{ in}}  & {\em x\+\_\+id} & nr. of Eigenvalue \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+pot} & potential energy \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+kin} & kinetic energy \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+pot\+\_\+int} & integrated potential energy \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+kin\+\_\+int} & integrated kinetic energy \\
\hline
\end{DoxyParams}
...
\index{sol\_ops@{sol\_ops}!decompose\_energy@{decompose\_energy}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em mds\+\_\+x} & general modes variables in pertubation grid \\
\hline
\mbox{\texttt{ in}}  & {\em mds\+\_\+sol} & general modes variables in solution grid \\
\hline
\mbox{\texttt{ in}}  & {\em grid\+\_\+eq} & equilibrium grid \\
...
\mbox{\texttt{ in}}  & {\em b\+\_\+aligned} & whether grid is field-\/aligned \\
\hline
\mbox{\texttt{ in}}  & {\em xyz} & X, Y and Z for plotting \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+pot\+\_\+int} & integrated potential energy \\
\hline
\mbox{\texttt{ in,out}}  & {\em e\+\_\+kin\+\_\+int} & integrated kinetic energy \\
...
\index{sol\_ops@{sol\_ops}!plot\_harmonics@{plot\_harmonics}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em mds} & general modes variables in solution grid \\
\hline
\mbox{\texttt{ in}}  & {\em grid\+\_\+sol} & solution grid \\
\hline
\mbox{\texttt{ in}}  & {\em sol} & solution variables \\
\hline
\mbox{\texttt{ in}}  & {\em x\+\_\+id} & nr. of Eigenvalue (for output name) \\
\hline
\mbox{\texttt{ in}}  & {\em res\+\_\+surf} & resonant surfaces \\
\hline
\end{DoxyParams}
...
\index{sol\_ops@{sol\_ops}!plot\_sol\_vals@{plot\_sol\_vals}}
\index{plot\_sol\_vals@{plot\_sol\_vals}!sol\_ops@{sol\_ops}}
\doxysubsubsection{\texorpdfstring{plot\_sol\_vals()}{plot\_sol\_vals()}}
{\footnotesize\ttfamily subroutine, public sol\+\_\+ops\+::plot\+\_\+sol\+\_\+vals (\begin{DoxyParamCaption}\item[{type(\mbox{\hyperlink{structsol__vars_1_1sol__type}{sol\+\_\+type}}), intent(in)}]{sol,  }\item[{integer, intent(in)}]{last\+\_\+unstable\+\_\+id }\end{DoxyParamCaption})}
...
\mbox{\texttt{ in}}  & {\em sol} & solution variables \\
\hline
\mbox{\texttt{ in}}  & {\em last\+\_\+unstable\+\_\+id} & index of last unstable EV \\
\hline
\end{DoxyParams}
...
\index{sol\_ops@{sol\_ops}!plot\_sol\_vec@{plot\_sol\_vec}}
...
\mbox{\texttt{ in}}  & {\em sol} & solution variables \\
\hline
\mbox{\texttt{ in}}  & {\em xyz} & X, Y and Z of extended eq\+\_\+grid \\
\hline
\mbox{\texttt{ in}}  & {\em x\+\_\+id} & nr. of Eigenvalue (for output name) \\
\hline
\mbox{\texttt{ in}}  & {\em plot\+\_\+var} & whether variables are plotted (1\+: plasma perturbation, 2\+: magnetic perturbation) \\
\hline
\end{DoxyParams}
...
\index{sol\_ops@{sol\_ops}!print\_output\_sol@{print\_output\_sol}}
...
{\footnotesize\ttfamily integer function, public sol\+\_\+ops\+::print\+\_\+output\+\_\+sol (\begin{DoxyParamCaption}\item[{type(\mbox{\hyperlink{structgrid__vars_1_1grid__type}{grid\+\_\+type}}), intent(in)}]{grid,  }\item[{type(\mbox{\hyperlink{structsol__vars_1_1sol__type}{sol\+\_\+type}}), intent(in)}]{sol,  }\item[{character(len=$\ast$), intent(in)}]{data\+\_\+name,  }\item[{integer, intent(in), optional}]{rich\+\_\+lvl,  }\item[{logical, intent(in), optional}]{remove\+\_\+previous\+\_\+arrs }\end{DoxyParamCaption})}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em grid} & solution grid variables \\
\hline
\mbox{\texttt{ in}}  & {\em sol} & solution variables \\
\hline
...
\index{sol\_ops@{sol\_ops}!debug\_calc\_e@{debug\_calc\_e}}
...
\index{sol\_ops@{sol\_ops}!debug\_du@{debug\_du}}
...
\index{sol\_ops@{sol\_ops}!debug\_plot\_sol\_vec@{debug\_plot\_sol\_vec}}
...
plot debug information for \mbox{\hyperlink{namespacesol__ops_a13b3cf2fb6437a3c93256368fa91c267}{plot\+\_\+sol\+\_\+vec()}} 
...
\index{sol\_ops@{sol\_ops}!debug\_x\_norm@{debug\_x\_norm}}
